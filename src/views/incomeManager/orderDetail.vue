  ...
  <div>
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />入库单编号:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />入库单创建时间:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />入库状态:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />供应商:</el-col>
      <el-col
        :span="6"
      ><div class="grid-content bg-purple" />{{ checkOrder.status }}</el-col>
    </el-row>
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />采购员:</el-col>
      <el-col
        :span="6"
      ><div class="grid-content bg-purple" />{{ checkOrder.buyer }}</el-col>
    </el-row>
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />验货员:</el-col>
      <el-col
        :span="6"
      ><div class="grid-content bg-purple" />{{ checkOrder.checker }}</el-col>
    </el-row>
    <!-- 表格 -->
    <!-- 表格 -->
    <el-table
