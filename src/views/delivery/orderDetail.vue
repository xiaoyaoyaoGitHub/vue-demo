  ...
  <div>
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />发货单编号:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />关联出库编号:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />发货单创建时间:</el-col>
      <el-col
        :span="6"
      ><div class="grid-content bg-purple" />{{ checkOrder.createTime }}</el-col>
    </el-row>
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />发货单状态:</el-col>
      <el-col
        :span="6"
    ...
    <el-row :gutter="10">
      <el-col
        :span="3"
        class="labelName"
      ><div class="grid-content bg-purple" />处理时间:</el-col>
      <el-col
        :span="6"
      ><div class="grid-content bg-purple" />{{ checkOrder.status }}</el-col>
    </el-row>
